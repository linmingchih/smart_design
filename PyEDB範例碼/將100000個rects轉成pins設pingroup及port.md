...
t0 = time.time()
rectangles = edb.modeler.rectangles
...
u1 = edb.components.create_component_from_pins(VDD_pins+VSS_pins, 'comp1')
pg1 = edb.components.create_pingroup_from_pins(VDD_pins)
pg2 = edb.components.create_pingroup_from_pins(VSS_pins)
edb.siwave.create_circuit_port_on_pin_group(pg1.GetName(), pg2.GetName())
edb.save_edb_as('d:/demo/test17.aedb')
